...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit"><i class="icon-ok icon-white glyphicon glyphicon-ok"></i></button>'+
                                '<button type="button" class="btn editable-cancel"><i class="icon-remove glyphicon glyphicon-remove"></i></button>';         
